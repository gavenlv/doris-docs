...
echo "========================================"
echo "Doris FE Setup - Public Network Mode"
...
echo "========================================"
echo "NOTE: Running in public network - downloading from internet"
echo "========================================"
...
# Download Doris FE from internet (public network mode)
DORIS_VERSION="4.0.2"
DORIS_MIRROR="https://archive.apache.org/dist/doris"
FE_PACKAGE="apache-doris-fe-${DORIS_VERSION}-bin-x86_64.tar.gz"

echo "Downloading Doris FE ${DORIS_VERSION} from Apache mirror..."
...
# Install FoundationDB client if enabled (from internet)
